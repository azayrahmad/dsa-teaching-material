...
const translations = {
  id: {
    ...
    viewSlidesPart1: "Lihat Slide (Bagian 1 - Dasar)",
    viewSlidesPart2: "Lihat Slide (Bagian 2 - Lanjutan)",
  ...
  en: {
    ...
    viewSlidesPart1: "View Slides (Part 1 - Basics)",
    viewSlidesPart2: "View Slides (Part 2 - Advanced)",
